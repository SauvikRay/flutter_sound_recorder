...
import 'package:soun_and_record/sound/flutter_sound.dart';
...
class _SimpleRecorderState extends State<SimpleRecorder> {
  ...
  ///http://console.nijje.com/audio_clips/2022-12/qLSI2kfLV078RPngDvbZVi69I0iNPmMn6VIxpoIJ.aac
  void play() {
    final playLink =
        'http://console.nijje.com/audio_clips/2022-12/qLSI2kfLV078RPngDvbZVi69I0iNPmMn6VIxpoIJ.aac';
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () async {
              audioFile = File(path);
              // await StoreChatApi()
              //     .storeChatApi(lessonId: 1, audioFile: audioFile);
            },
          ),
        ],
      );
